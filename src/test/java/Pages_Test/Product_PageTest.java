...
String header=ppg.productHeader();
Assert.assertEquals(header, "PRODUCTS");
}
@Test(priority=3)
public void imgTest() {
 driver.findElement(By.xpath("//a[@id='item_4_img_link']")).isDisplayed();
	Assert.assertTrue(driver.findElement(By.xpath("//a[@id='item_4_img_link']")).isDisplayed());
}
@Test(priority=5)
